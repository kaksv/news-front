  ...
  return (
    <div>
       ...
       <Container>
            ...
            <Row className='mt-3'>
                <div className='col-12'>
                    <textarea type='text' className='form-control' placeholder='Summary' value={summary} onChange={(e) => setSummary(e.target.value)}/> 
                </div>
            </Row>
            <Row className='mt-3'>
                <div className='col-12'>
                    <textarea rows='10' type='text' className='form-control' placeholder='Content' value={content} onChange={(e) => setContent(e.target.value)} /> 
                </div>
            </Row>
            <Row className='mt-3'>
                <div className='col-12'>
